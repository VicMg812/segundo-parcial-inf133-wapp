...
from models.patient_model import Hospytal
...
def create_patient():
    if request.method == "POST":
        # if current_user.has_role("admin"):
            ...
            patient = Hospytal(name=name, last_name=last_name, ci=ci, birth_date=birth_date)
            patient.save()
